...
var BASE_URL = '//' + location.host + '/lidjenti_back/';
...
var listofrequests_assoc =
    {
        ...
        'secteuractivitemotcles': 'id,mot_cle_id,secteur_activite_id,mot_cle{id},secteur_activite{id}',
        'entreprises': 'id,email,raison_social,logo,numero_telephone,active,affiliations_emet{id,statut,entreprise_emettrice_id,entreprise_receptrice_id},affiliations_recep{id,statut,entreprise_emettrice_id,entreprise_receptrice_id},last_login,secteur_activite_id,secteur_activite{id,libelle},created_at,nb_subscription,nb_produit,nb_affiliation,nb_demande_devis,nb_bon_commande,nb_bon_livraison,pc_subscription,pc_produit,pc_affiliation,pc_demande_devis,pc_bon_commande,pc_bon_livraison',
        'abonnementfonctionnalites': 'id,code,designation,nombre,abonnement_id,fonctionnalite_id,abonnement{id},fonctionnalite{id}',
        'abonnements': 'id,libelle,montant,nombre,created_at, fonctionnalites, abonnement_fonctionnalites{id,code,designation,nombre,abonnement_id,fonctionnalite_id},entreprise_abonnements{id,entreprise_id,abonnement_id,entreprise{id,raison_social,logo,email,secteur_activite{id, libelle}, numero_telephone},abonnement{id}}',
        'souscriptions': 'id,date,date_fr,date_expiration,statut,created_at_fr, abonnement_id,abonnement{id,libelle,nombre},entreprise_id,entreprise{id,email,raison_social,logo,numero_telephone},user{name,image},montant,created_at',
        'affiliations': 'id,statut,entreprise_emettrice_id,entreprise_receptrice_id,entreprise_emettrice{id,raison_social,logo},entreprise_receptrice{id,raison_social,logo}',
        'bcproduitbls': 'id,quantite,bon_livraison_id,bon_commande_produit_id,bon_livraison{id},bon_commande_produit{id}',
        'boncommandeproduits': 'id,quantite,prix,bon_commande_id,produit_id,demande_devis_produit_id,bon_commande{id},produit{id},demande_devis_produit{id}',
        'boncommandes': 'id,date_emission,entreprise_emetteur{id,raison_social},entreprise_recepteur{id,raison_social},etat,demande_devis_id,affiliation_id,entreprise_abonnement_id,demande_devis{id,entreprise_emetteur{id,raison_social},entreprise_recepteur{id,raison_social}},affiliation{id},entreprise_abonnement{id}',
        'bonlivraisons': 'id,date_emission,date_reception,etat,code_livraison,entreprise_abonnement_id,bon_commande_id,entreprise_abonnement{id},bon_commande{id,entreprise_emetteur{id,raison_social},entreprise_recepteur{id,raison_social},demande_devis{id,entreprise_emetteur{id,raison_social},entreprise_recepteur{id,raison_social}}}',
        'demandedevisproduits': 'id,quantite,prix,demande_devis_id,,statut,reference,designation,produit_id,demande_devis{id,entreprise_emettrice_id,entreprise_receptrice_id},is_tva,produit{id,designation}',
        'demandedevis': 'id,date_envoie,nbr_produit,is_tva,demande_devis_produits{id,designation,quantite,prix,produit{id,designation},statut,reference},date_recu,statut,affiliation_id,entreprise_abonnement_id,entreprise_emettrice_id,entreprise_receptrice_id,affiliation{id},entreprise_abonnement{id},entreprise_emetteur{id,raison_social},entreprise_recepteur{id,raison_social}',
        'entrepriseabonnements': 'id,displaystatut,displaycolorstatut,date,date_fr,date_expiration,abonnement_id,abonnement{id,libelle,nombre},entreprise_id,entreprise{id,email,raison_social,logo,numero_telephone},user{name,image},montant,created_at',
        'familleproduits': 'id,designation,famille_produit_id,entreprise_id,entreprise{id},famille_produit{id,designation,famille_produit_id,famille_produit{id,designation}}',
        'fonctionnalites': 'id,libelle,code',
        'produits': 'id,reference,designation,description,entreprise_id,famille_produit_id,entreprise{id},famille_produit{id,designation}',
        'roles': 'id,name,guard_name,permissions{id,name,display_name,guard_name}',
        'permissions': 'id,name,display_name,guard_name,description',
        'rolepermissions': 'id,role_id,permission_id,role{id},permission{id}',
        ...
        'dashboards': 'totalEntreprise,totalAbonnement,totalDemandeDevis,totalUser,totalSouscripValide,totalSouscripInvalide',
        'notifications': 'id,type_notification_id,ent_emt_id,ent_rcp_id,type_notification{id,name,rank},entreprise_emt{id,raison_social},entreprise_rcp{id,raison_social}',
        'messageries': 'id,ent_emt_id,ent_rcp_id,created_at,message,entreprise_emt{id,raison_social},entreprise_rcp{id,raison_social}',
        'uniteconditionnements': 'id,entreprise_id,uc,entreprise{id,raison_social}',
    };
